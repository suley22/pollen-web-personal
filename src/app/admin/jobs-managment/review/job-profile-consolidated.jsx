...
4. Customer Focus & Values Alignment: Excellent - Candidate shows genuine care for customer experience. Poor - Candidate lacks customer empathy or understanding.`,
    ...
    const getCompleteButtonDisabledReason = () => {
        ...
        if (candidateCompletionData.pendingFeedback > 0) {
            return `${candidateCompletionData.pendingFeedback} candidate${candidateCompletionData.pendingFeedback !== 1 ? "s" : ""
                } still need feedback`;
        }
        return null;
    };
                ...
                {job.status !== "draft" && (
                    <Card className="mb-6 p-6">
                        ...
                        <CardContent className="space-y-4">
                            ...
                            <div className="flex items-center justify-between">
                                <div
                                    className={`flex items-center gap-2 px-3 py-2 rounded-lg ${job.status === "live"
                                ...
                                >
                                    <div
                                        className={`w-2 h-2 rounded-full ${job.status === "live"
                                            ? "bg-green-500"
                                            : job.status === "paused"
                                                ? "bg-yellow-500"
                                                : job.status === "complete"
                                    ...
                                    />
                                    <span
                                        className={`text-sm font-medium ${job.status === "live"
                                            ? "text-green-700"
                                            : job.status === "paused"
                                                ? "text-yellow-700"
                                                : job.status === "complete"
                                ...
                                <div className="space-y-3">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        {candidateCompletionData && (
                                            <div
                                                className={`text-xs px-2 py-1 rounded-full border ${canMarkComplete()
