  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        {state === "collapsed" ? (
          <div className="hover:text-accent-foreground data-[state=open]:text-accent-foreground cursor-pointer flex items-center justify-center focus:ring-0 focus:outline-none">
