...
export default function JobsPage() {
  ...
  return (
    <div className="mx-auto space-y-4 jobs-page">
      <div className="text-left mb-6">
        <div className="mb-4 pt-6">
          <Header
            titleSize="text-2xl"
            title="Find your next opportunity"
            subtitle={"Explore a curated list of entry-level jobs for you."}
          />
        </div>
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-lg p-5">
            ...
            <div className="text-xs text-gray-600">
              <p>
                ...
                and we don&apos;t endorse the companies or positions listed, so
                please make sure to research each opportunity before applying.
              </p>
            </div>
          </div>
        </div>
