            ...
            <div>
              ...
              <div className="flex items-center space-x-4 mt-2">
                ...
                <span className="text-sm text-muted-foreground">
                  {company.profileCompleteness}% complete
                </span>
              </div>
            </div>
          </div>
        ...
        <div className="flex space-x-2">
          {isEditing ? (
            ...
            <>
              ...
              {company.approval_status === "live" && (
                <Button
                  variant="outline"
                  size="sm"
                  // TODO: Implement handleHideProfile
              ...
              {company.approval_status === "hidden" && (
                <Button
                  size="sm"
                  // TODO: Implement handleSetLive
                  // onClick={handleSetLive}
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card className="p-6">
            <CardHeader className="pb-4">
              <CardTitle className="flex items-center space-x-2 pb-4">
