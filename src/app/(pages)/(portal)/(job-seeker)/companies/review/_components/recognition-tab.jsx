      ...
      <CardHeader>
        <div className="flex items-center justify-between">
          ...
          <Button
            onClick={() =>
              setExpandedSection(
                expandedSection === "recognition" ? null : "recognition",
              )
            }
            variant="outline"
        ...
        {expandedSection === "recognition" ? (
              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <input
                    type="text"
                    className="w-full p-2 border border-gray-300 rounded-md"
                    placeholder="e.g. Great Place to Work Institute"
                  />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">
          ...
          <div className="text-center py-8">
            ...
            <p className="text-gray-600" style={{ fontFamily: "Poppins" }}>
              Highlight your company awards, certifications, and industry
              recognition to stand out to candidates.
            </p>
          </div>
        )}
      </CardContent>
