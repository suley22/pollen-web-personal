...
export function InternalPollenData({ employer = null }) {
  return (
    <FormCard
    ...
    >
      <div className="space-y-6">
        ...
        <Select
          ...
          defaultValue={employer?.how_did_you_hear_about_us}
        />
        ...
        <Textarea
          ...
          defaultValue={employer?.more_info}
        />
        ...
        <Select
          ...
          placeholder="Select an option"
          defaultValue={employer?.hiring_frequency}
        />
        ...
        <InputCheckboxGroup
          ...
          initialSelectedItems={employer?.previous_hiring_methods || []}
          columns={2}
        />
        ...
        <Textarea
          ...
          defaultValue={employer?.additional_notes}
        />
      </div>
    </FormCard>
  );
